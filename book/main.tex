...
\newcommand{\precapprox}{\textcolor{dorange}{\textbf{[近似]}}}
...
\precapprox & 近似成立 & 在指定近似条件下的结果（如Newton引力为GR的弱场低速极限） \\
...
\begin{itemize}
  ...
  \item \textbf{精确程度标记}（\precexact/\preceffective/\precapprox/\precqualitative/\preccontingent）：每条定律和关系标注精度等级，避免"所有公式都同等精确"的误解。
